          ...
          <div key={product.id} className="group">
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden">
              ...
              <div className="relative overflow-hidden">
                ...
                />
                {product.isNew && (
                  <div className="absolute top-2 sm:top-4 right-2 sm:right-4 bg-red-500 text-white px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-bold">
                    جديد
                  </div>
                )}
                {product.discount && (
                  <div className="absolute top-2 sm:top-4 left-2 sm:left-4 bg-green-500 text-white px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-bold">
                    -{product.discount}%
                  </div>
                )}
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-all duration-300 flex items-center justify-center">
                  <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 flex space-x-2 space-x-reverse">
                    <button className="bg-white text-blue-600 p-2 sm:p-3 rounded-full hover:bg-blue-600 hover:text-white transition-colors duration-300">
              ...
              <div className="p-4 sm:p-6">
                <h3 className="font-bold text-base sm:text-lg mb-2 text-gray-800 group-hover:text-blue-600 transition-colors duration-300">
                  {product.name}
                </h3>
                ...
                <div className="flex items-center mb-3 sm:mb-4">
                  ...
                  <span className="text-xs sm:text-sm text-gray-500 mr-2">({product.reviews})</span>
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
                  ...
                  <button className="bg-blue-600 hover:bg-blue-700 text-white px-3 sm:px-4 py-2 rounded-lg font-medium transition-colors duration-300 text-xs sm:text-sm">
                    اطلب عرض سعر
                  </button>
                </div>
              </div>
        ...
        <div className="flex justify-center mt-8 sm:mt-12">
          {Array.from({ length: totalSlides }).map((_, index) => (
            <button
              ...
              className={`mx-1 sm:mx-2 w-3 h-3 sm:w-4 sm:h-4 rounded-full transition-all duration-300 ${
                currentIndex === index 
